...
//indexOf(searchElement) --> returns the index of the first occurence of element given in the array
// returns -1 if element not found

console.log(fruits.indexOf);

//findIndex(predicate:value) --> returns index of first occurence of element in array
// that satisfies a specific condition

let userIndexFromSK = userInfo.findIndex((user) => {
  return user.Country === "South Korea";
});

console.log(userIndexFromSK);